    ...
    <>
      ...
      <div className="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
        ...
        <div className="flex flex-wrap justify-center">
          <div>
            <img src={"https://ui-avatars.com/api/?name=" + "Annas" + "+" + "Abdurrahman" + "&background=random&size=128&rounded=true"} alt="..." className="rounded max-w-full h-auto align-middle border-none" />
          </div>
        </div>
